...
For a short, action-free instruction that Benson can paste into Claude to teach only the current deal-owner behaviour, use [`CLAUDE-DEAL-OWNER-INSTRUCTION.md`](CLAUDE-DEAL-OWNER-INSTRUCTION.md).
